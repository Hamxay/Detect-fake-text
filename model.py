...
class GPT2PPL:
    ...
    def getResults(self, threshold):
        ...
        if threshold < 60:
            ...
            label = 1
            return "The Text is writte  n by Human.", label
    ...
    def __call__(self, sentence):
        ...
        mean_perplexity = statistics.mean(Perplexity_per_line)
        results["Mean Perplexity"] = sum(Perplexity_per_line)/len(Perplexity_per_line)

        print(f"Burstiness {max(Perplexity_per_line)}")
        results["Burstiness"] = max(Perplexity_per_line)

        out, label = self.getResults(results["Mean Perplexity"])
        results["label"] = label
    ...
    def getPPL(self,sentence):
        ...
        print("likelihoods",likelihoods, ppl)
        return ppl
